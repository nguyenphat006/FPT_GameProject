...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            const showImage = {
                "Home.useEffect.showImage": (index)=>{
                    images.forEach({
                        "Home.useEffect.showImage": (img, i)=>{
                            img.classList.toggle("active", i === index);
                        }
                    }["Home.useEffect.showImage"]);
                }
            }["Home.useEffect.showImage"];
            const nextImage = {
                "Home.useEffect.nextImage": ()=>{
                    currentIndex = (currentIndex + 1) % totalImages;
                    showImage(currentIndex);
                }
            }["Home.useEffect.nextImage"];
            const prevImage = {
                "Home.useEffect.prevImage": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            const handleMenuClose = {
                "Home.useEffect.handleMenuClose": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            const handleTouchMove = {
                "Home.useEffect.handleTouchMove": (e, card)=>{
            ...
            const resetTilt = {
                "Home.useEffect.resetTilt": (card)=>{
                    card.style.transform = "rotateX(0deg) rotateY(0deg)";
                }
            }["Home.useEffect.resetTilt"];
            cards.forEach({
                "Home.useEffect": (card)=>{
                    card.addEventListener("touchmove", {
                        "Home.useEffect": (e)=>handleTouchMove(e, card)
                    }["Home.useEffect"]);
...
_s(Home, "xInIZckOhfWWeCCsCyqjlH0VhGE=");
_c = Home;
var _c;
